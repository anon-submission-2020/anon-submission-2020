...
This repository contains code and trained models for the XXX 2020 submission **Testing Robustness Against Unforeseen Adversaries**.
...
```
git clone git@github.com:anon-submission-2020/anon-submission-2020.git
cd advex-uar
pip install .
```
